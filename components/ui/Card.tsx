...
function Card({ title, media, type, link }: Maincardprops) {
  ...
  return (
    <div className="relative group w-full sm:w-[360px] md:w-[420px]">
      {/* Glow efek */}
      <div className="absolute -inset-1 bg-gradient-to-r from-blue-400/50 via-orange-300/50 to-blue-400/50 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      <div className="relative bg-white/80 backdrop-blur-md rounded-2xl overflow-hidden border-2 border-white/60 shadow-xl transition-transform duration-500 group-hover:-translate-y-2 group-hover:scale-[1.02]">
        {thumbnailUrl && (
          <a href={targetUrl} target="_blank" rel="noopener noreferrer">
            <div className="relative aspect-video w-full h-auto overflow-hidden bg-gradient-to-br from-blue-100 to-orange-100">
              {/* Label type */}
            ...
            {/* Title */}
            <div className="p-4 bg-gradient-to-br from-blue-50/80 to-white/80 backdrop-blur-sm">
